...
**Protected Routes:** /dashboard, /account, /events, /artists, /venues
**Onboarding:** 3 steps
...
**Steps:**
1. Create an Account: Sign up for a SoundScout account
2. Create an Event: Create a new live music event
3. Discover Events: Search and view live music events
